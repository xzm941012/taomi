...
import com.example.de.taomi2.adapter.Shop_adapter;
...
public class Activity_shop extends Activity {
    ...
    private void initListennner(){
        findViewById(R.id.relativeLayout24).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Activity_shop.this,Activity_fabu_shangping.class));
            }
        });
    }
    ...
    class MyTask extends AsyncTask<String,Void,List<ShangPingItem>> {
        ...
        protected List<ShangPingItem> doInBackground(String... params) {
            ...
            try {
                shangPingItemList= Manage.viewShangpinlistByUserid(MyApplication.school, MyApplication.loudong, MyApplication.user.getId() + "");
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        protected void onPostExecute(List<ShangPingItem> shangPingItemList){
            adapter=new Shop_adapter(Activity_shop.this,shangPingItemList);
