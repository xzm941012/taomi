...
import com.example.de.taomi2.http.FormFile;
import com.example.de.taomi2.http.PostUrl;
import com.example.de.taomi2.http.SocketHttpRequester;
...
public class UploadFile {
	public static String uploadUrl= PostUrl.getUploadImageUrl();
    ...
    public static String uploadFileStruct(String url,String name) {
        ...
        try {
            ...
            // 上传文件
            FormFile formfile = new FormFile(name, imageFile,
