 ...
 */
public class Shop_qingshizhang_adapter extends BaseAdapter {
    ...
    public Shop_qingshizhang_adapter(Context context, List<ShangPingItem> data) {
        ...
        if(item.getZhuangtai().equals("1")){
            ...
            holder.zhuangtai.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    myTask.execute(item.getId()+"","0","chaoshi");
                }
            });
        }else{
            holder.zhuangtai.setText("上架");
            holder.zhuangtai.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    item.setZhuangtai("1");
                    ChanceZhungtai myTask=new ChanceZhungtai();
                    myTask.execute(item.getId()+"","1","chaoshi");
                }
            });
        }
