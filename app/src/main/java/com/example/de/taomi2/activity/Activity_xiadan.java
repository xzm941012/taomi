 ...
 */
public class Activity_xiadan extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog(Activity_xiadan.this);
    ...
    private void initListenner(){
        ...
        findViewById(R.id.relativeLayout14).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivityForResult(new Intent(Activity_xiadan.this,Activity_editliuyan.class),1);
            }
        });
        findViewById(R.id.button3).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(address.getText().toString().equals("")){
                    Toast.makeText(Activity_xiadan.this,"写个地址啊",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(lianxiStyle.getText().toString().equals("")){
                    Toast.makeText(Activity_xiadan.this,"联系方式啊",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(rb1.isChecked()) {
                    ...
                    // 发起支付
                    PayActivity.CallPayActivity(Activity_xiadan.this, bill.toString(), URL);
                }
            }
        });
    }
    ...
    class MyTask extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... params) {
            String result=null;
            try {
                result= Manage.pushDingdan(dingDan);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return result;
        ...
        protected void onPostExecute(String result){
            ...
            if(result.trim().equals("true")){
                Toast.makeText(Activity_xiadan.this,"下单成功，预计20分钟到达",Toast.LENGTH_SHORT).show();
                GouWuChe.clearGouWuChe();
                setResult(ResultUtil.CHAOSHI_XIADAN);
                finish();
            }else{
                Toast.makeText(Activity_xiadan.this,"未知错误",Toast.LENGTH_SHORT).show();
            }
